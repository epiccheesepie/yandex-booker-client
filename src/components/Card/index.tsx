    ...
    return (
        <div className="card">
            ...
            <div className="card__text">
                ...
                <h3><span className="card__static">Isbn: </span><span className="card__changed">{isbn.join(', ')}</span></h3>
                <h3><span className="card__static">Издатели: </span><span className="card__changed">{publishers.join(', ')}</span></h3>
            </div>
        </div>
    );
};
